...
vignette: >
  %\VignetteIndexEntry{Introduction to preprocess}
...
# packages
library(tidyverse) # manipulate data, data viz
library(rio)       # import data
library(scales)    # helper 
library(gt)        # print table with formattig
library(NADA)      # compute distribution parameters on censored data
library(msm)       # random draw in truncated normal distribution
library(preprocess)
```
